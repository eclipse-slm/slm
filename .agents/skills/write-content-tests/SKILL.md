...
description: "Write functional tests for Ansible content (roles, playbooks) using\
  \ Molecule. Focuses on verifying intended outcomes \u2014 does the automation achieve\
  \ its goal? \u2014 not retesting built-in modules. Use when writing new Molecule\
  \ scenarios, verify playbooks, or improving existing tests. Do NOT use for Python\
  \ module unit/integration tests (use write-module-tests)."
---
