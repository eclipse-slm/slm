---
name: tox-lint
description: 'Runs configured tox linters on an Ansible collection or Python project.
  Use this skill when you need to validate code quality with ansible-lint, black,
  isort, flake8, pylint, flynt, or ruff before commits or releases.
