...
public interface CredentialManagementRestApi {
    ...
    @ResponseBody
    ResponseEntity<CredentialReadDTO> getCredentialById(@PathVariable(name = "credentialId") UUID credentialId);

    @RequestMapping(value = "/{credentialId}/data", method = RequestMethod.GET)
    @Operation(summary = "Get credential data by id")
    @ResponseBody
    ResponseEntity<CredentialData> getCredentialDataById(
    ...
    @ResponseBody
    ResponseEntity<Void> createCredential(@RequestBody CredentialCreateRequest credentialCreateRequest);

    @RequestMapping(value = "/{credentialId}", method = RequestMethod.PUT)
    @Operation(summary = "Create or update credential")
    @ResponseBody
    ResponseEntity<Void> createOrUpdateCredential(
            @PathVariable(name = "credentialId") UUID credentialId,
    ...
    @ResponseBody
    ResponseEntity<Void> deleteCredential(@PathVariable(name = "credentialId") UUID credentialId);

    @RequestMapping(value = "/entities/{entityId}", method = RequestMethod.GET)
    @Operation(summary = "Get credentials of entity")
    @ResponseBody
    ResponseEntity<List<CredentialReadDTO>> getCredentialsOfEntity(
    ...
    @ResponseBody
    ResponseEntity<Void> deleteCredentialEntityLink(
            @PathVariable(name = "credentialId") UUID credentialId,
            @RequestParam(value = "entityType") String entityType,
    ...
    @ResponseBody
    ResponseEntity<Void> addCredentialScopes(
            @PathVariable(name = "credentialId") UUID credentialId,
    ...
    @ResponseBody
    ResponseEntity<Void> removeCredentialScopes(
            @PathVariable(name = "credentialId") UUID credentialId,
            @RequestBody List<String> scopes);
}
