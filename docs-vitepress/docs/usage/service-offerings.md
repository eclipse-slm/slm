...
![service-offering-create-1](/img/figures/use/service-offerings/service-offering-create-1.png)

Click on `SERVICE OFFERING WIZARD`.
![service-offering-create-via-wizard-1](/img/figures/use/service-offerings/service-offering-create-via-wizard-1.png)

Enter the details of the new service offering and click on `CREATE`.
![service-offering-create-via-wizard-2](/img/figures/use/service-offerings/service-offering-create-via-wizard-2.png)
...
![service-offering-create-via-wizard-3](/img/figures/use/service-offerings/service-offering-create-via-wizard-3.png)
...
![service-offering-create-via-wizard-4](/img/figures/use/service-offerings/service-offering-create-via-wizard-4.png)

Enter the details used to deploy a Docker container based on the service offering version.
![service-offering-create-via-wizard-5](/img/figures/use/service-offerings/service-offering-create-via-wizard-5.png)
...
![service-offering-create-via-wizard-6](/img/figures/use/service-offerings/service-offering-create-via-wizard-6.png)

The service offering version gets created and will be shown as a version of the newly created service offering.
![service-offering-create-via-wizard-7](/img/figures/use/service-offerings/service-offering-create-via-wizard-7.png)
...
![service-offering-create-via-git-1](/img/figures/use/service-offerings/service-offering-create-via-git-1.png)
...
![service-offering-create-via-git-2](/img/figures/use/service-offerings/service-offering-create-via-git-2.png)
...
![service-offering-create-via-git-3](/img/figures/use/service-offerings/service-offering-create-via-git-3.png)
