package org.eclipse.slm.common.aas.clients.submodelservice;
...
public class SubmodelServiceClient {
    ...
    public SubmodelServiceClient(String submodelServiceUrl, AuthRequestInterceptor authRequestInterceptor) {
        this. submodelServiceUrl = submodelServiceUrl;
        var apiClient = ClientUtils.getApiClient(submodelServiceUrl, authRequestInterceptor);
    ...
    public static SubmodelServiceClient FromSubmodelDescriptor(SubmodelDescriptor submodelDescriptor, JwtAuthenticationToken jwtAuthenticationToken) {
        ...
        if (submodelEndpoint.endsWith("/submodel")) {
            ...
            if (matchesFound) {
                ...
                var submodelServiceClient = new SubmodelServiceClient(submodelServiceBasUrl, new JwtAuthenticationTokenAuthRequestInterceptor(jwtAuthenticationToken));
