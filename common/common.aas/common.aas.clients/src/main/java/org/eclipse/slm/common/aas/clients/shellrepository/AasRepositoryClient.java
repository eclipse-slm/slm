package org.eclipse.slm.common.aas.clients.shellrepository;
...
public class AasRepositoryClient {
    ...
    public AasRepositoryClient(String aasRepositoryUrl, AuthRequestInterceptor authRequestInterceptor) {
        var apiClient = ClientUtils.getApiClient(aasRepositoryUrl, authRequestInterceptor);
