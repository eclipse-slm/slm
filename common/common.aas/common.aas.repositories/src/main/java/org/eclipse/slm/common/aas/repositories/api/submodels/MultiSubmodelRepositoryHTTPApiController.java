...
public abstract class MultiSubmodelRepositoryHTTPApiController implements MultiSubmodelRepositoryHTTPApi {

    private SubmodelRepositoryFactory submodelRepositoryFactory;

    public MultiSubmodelRepositoryHTTPApiController(SubmodelRepositoryFactory submodelRepositoryFactory) {
