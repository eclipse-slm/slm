...
public interface AasRepositoryHTTPApi {
	...
	@Operation(summary = "Deletes an Asset Administration Shell", description = "")
	...
	@Operation(summary = "Returns all Asset Administration Shells", description = "")
	@ApiResponses(value = {
	...
	@Operation(summary = "Updates an existing Asset Administration Shell", description = "")
	...
	@Operation(summary = "Updates the Asset Information", description = "")
