...
//        when(this.resourceManagementClientFactory.create(any(String.class))).thenReturn(this.apiClient);
...
//        verify(this.).registerServiceForNodeWithReadAccessViaKeycloakRole(
//                nodeIdArg.capture(),
