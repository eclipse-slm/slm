...
import org.eclipse.slm.service_management.features.service_deployment.api.deploymentdefinitions.ArrayMapNodeDeserializer;
...
public final class DockerComposeFileParser {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(DockerComposeFileParser.class);
