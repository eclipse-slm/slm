...
public class ServiceInstanceEventMessageSender extends GenericMessageSender<ServiceInstanceEventMessage> {
    ...
    public void sendMessage(ServiceInstance serviceInstance, ServiceInstanceEventType eventType) {
        this.sendMessage(serviceInstance, eventType, null);
    }

    public void sendMessage(ServiceInstance serviceInstance, ServiceInstanceEventType eventType, Set<String> ownerGroups) {
        var eventMessage = new ServiceInstanceEventMessage(serviceInstance, eventType, ownerGroups);
