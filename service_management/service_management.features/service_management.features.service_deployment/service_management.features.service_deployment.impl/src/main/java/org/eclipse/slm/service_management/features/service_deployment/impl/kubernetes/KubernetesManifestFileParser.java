package org.eclipse.slm.service_management.features.service_deployment.impl.kubernetes;
...
public final class KubernetesManifestFileParser {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(KubernetesManifestFileParser.class);
