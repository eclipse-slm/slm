...
import org.eclipse.slm.service_management.features.service_offerings.api.offerings.ServiceOfferingGitRepository;
...
public class ServiceOfferingGitUpdater implements ServiceOfferingGitUpdateTaskListener {
    ...
    public ServiceOfferingGitUpdater(
            ...
            @Value("${git.service-offering-importer.clone-directory}") String gitCloneDirectory, ServiceOfferingCategoryHandler serviceOfferingCategoryHandler, ServiceOfferingGitRepositoryJpaRepository serviceOfferingGitRepositoryJpaRepository) {
    ...
    public ServiceOfferingGitRepository checkoutTagsAndCreateDTOs(List<String> tagNames, ServiceOfferingGitRepository serviceOfferingGitRepository)
        ...
        for (var tagName : tagNames) {
            ...
            try {
                ...
                ServiceOfferingCategory serviceCategory;
                try {
                    var serviceCategoriesWithName = serviceOfferingCategoryHandler
                    ...
                    serviceCategory = new ServiceOfferingCategory(serviceOfferingDTOFileImport.getServiceCategoryName());
                    serviceCategory = serviceOfferingCategoryHandler.createServiceCategory(serviceCategory);
                }

                serviceOfferingCreateOrUpdateRequest = ServiceOfferingUtil.convertServiceOfferingDTOFileImportToDTOApi(
                        serviceOfferingDTOFileImport, gitRepo.getRepository().getWorkTree().getAbsolutePath(), serviceOfferingCategoryHandler.getServiceCategories());
