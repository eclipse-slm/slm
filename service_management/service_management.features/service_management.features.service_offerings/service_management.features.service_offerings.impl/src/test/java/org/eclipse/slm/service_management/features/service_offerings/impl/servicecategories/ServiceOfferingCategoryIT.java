...
@DataJpaTest
@ContextConfiguration(classes = ServiceOfferingCategoryTestConfig.class)
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@ActiveProfiles("test")
public class ServiceOfferingCategoryIT {
    ...
    public void findAllServiceCategories() {
        ...
        var testServiceCategory1 = new ServiceOfferingCategory(serviceCategoryName1);
        var testServiceCategory2 = new ServiceOfferingCategory(serviceCategoryName2);
    ...
    public void findServiceCategoryById() {
        ...
        var testServiceCategory = new ServiceOfferingCategory(serviceCategoryName);
    ...
    public void findServiceCategoryByName() {
        ...
        var testServiceCategory = new ServiceOfferingCategory(serviceCategoryName);
        testServiceCategory = entityManager.persist(testServiceCategory);
        var savedServiceCategory = entityManager.find(ServiceOfferingCategory.class, testServiceCategory.getId());
    ...
    public void saveServiceCategory() {
        var testServiceCategory = new ServiceOfferingCategory(UUID.randomUUID().toString());
    ...
    public void updateServiceCategory() {
        ...
        savedServiceCategory = entityManager.find(ServiceOfferingCategory.class, testServiceCategory.getId());
        assertThat(savedServiceCategory).isNotNull();
