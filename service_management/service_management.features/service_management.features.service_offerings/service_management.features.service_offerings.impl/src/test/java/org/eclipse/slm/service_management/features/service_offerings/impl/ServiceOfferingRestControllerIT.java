...
import org.eclipse.slm.service_management.features.service_offerings.impl.serviceofferings.ServiceOfferingGitUpdater;
import org.eclipse.slm.service_management.features.service_offerings.impl.serviceofferings.ServiceOfferingHandler;
import org.eclipse.slm.service_management.features.service_offerings.impl.serviceofferings.ServiceOfferingRestController;
...
public class ServiceOfferingRestControllerIT extends AbstractRestControllerIT {
    ...
    @Autowired
    private ResourceManagementClientFactory resourceManagementClientFactory;
    ...
    public void addTestServiceOfferings() throws IOException {
        ...
        /// Categories
        var testCategory = new ServiceOfferingCategory("TestCategory");
    ...
    public void addTestServiceOfferingDockerContainer(ServiceVendor vendor, ServiceOfferingCategory serviceCategory) throws IOException {
    ...
    public void addTestServiceOfferingDockerCompose(ServiceVendor vendor, ServiceOfferingCategory serviceCategory) throws IOException {
