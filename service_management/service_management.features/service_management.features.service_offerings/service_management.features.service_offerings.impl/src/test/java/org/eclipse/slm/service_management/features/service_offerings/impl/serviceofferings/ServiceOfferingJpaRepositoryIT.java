...
@DataJpaTest
@ContextConfiguration(classes = { ServiceOfferingJpaRepositoryTestConfig.class })
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@ActiveProfiles("test")
public class ServiceOfferingJpaRepositoryIT {
    ...
    protected ServiceOfferingCategory sampleServiceCategory = new ServiceOfferingCategory(UUID.randomUUID().toString());
    ...
    public class save {
        ...
        public void saveWithMissingServiceVendorAndServiceCategory() {
            ...
            Exception exception = assertThrows(DataIntegrityViolationException.class, () -> {
                serviceOfferingJpaRepository.saveAndFlush(testServiceOffering);
            });
