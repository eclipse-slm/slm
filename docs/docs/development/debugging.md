...
![failing-jobs-slm-overview](/img/figures/development/failing-jobs-slm-overview.png)
...
![failing-jobs-slm-overview-get-job-id](/img/figures/development/failing-jobs-slm-overview-get-job-id.png)
...
![failing-jobs-awx-overview](/img/figures/development/failing-jobs-awx-overview.png)
...
![failing-jobs-awx-job-details](/img/figures/development/failing-jobs-awx-job-details.png)
