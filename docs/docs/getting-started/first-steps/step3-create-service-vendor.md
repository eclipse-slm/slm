...
![](/img/figures/first-steps/first-steps-step3-admin-section.png)

Click on the `ADD SERVICE CATEGORY` button and enter any name you like:
![](/img/figures/first-steps/first-steps-step3-add-service-category.png)

Click on the `ADD SERVICE VENDOR` button and enter some details you like:
![](/img/figures/first-steps/first-steps-step3-add-service-vendor.png)
...
![](/img/figures/first-steps/first-steps-step3-add-developer.png)
