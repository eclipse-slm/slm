...
![](/img/figures/first-steps/first-steps-step4-select-service-vendor.png)

Click on the `ADD SERVICE OFFERING` button:
![](/img/figures/first-steps/first-steps-step4-add-service-offering-button.png)
...
| Click here to select image    | [![](/img/figures/first-steps/cover-node-red.png)](/img/figures/first-steps/cover-node-red.png)<br>(Click on image to download) |
